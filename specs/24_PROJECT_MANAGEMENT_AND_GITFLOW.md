...
[`19_DEVELOPMENT_DIARY_AND_LINKEDIN.md`](19_DEVELOPMENT_DIARY_AND_LINKEDIN.md)
...
require separate evidence from M4+ work. Career wording and application
publication remain owned by the career repository.
