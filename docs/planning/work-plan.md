...
**Next task:** RD-008 (`next`); the round is tracked in [`../tasks/redesign-ios27.md`](../tasks/redesign-ios27.md)  
...
RD-005 (History), RD-006 (Notes) and RD-007 (Pit capture sheet) have landed on `redesign/ios27`, and RD-008 is next; the app icon already shows the redesigned Pit (ICON-002, ADR 0037) as its announcement.
...
|---|---|---:|---|---|---|
| RD-008 | Sparse states: EmptyState on Road, Service, History, Notes and the first-launch board | 1d | RD-000 | next | REQ-GRAMMAR-004; no placeholder metric; wording unchanged; one or two actions |
