...
**Next task:** RD-011 (`next`); the round is tracked in [`../tasks/redesign-ios27.md`](../tasks/redesign-ios27.md)  
...
RD-005 (History), RD-006 (Notes), RD-007 (Pit capture sheet), RD-008 (sparse states), RD-009 (widgets) and RD-010 (utility layer in sheets) have landed on `redesign/ios27`, and RD-011 is next; the app icon already shows the redesigned Pit (ICON-002, ADR 0037) as its announcement.
