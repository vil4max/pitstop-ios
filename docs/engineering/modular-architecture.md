...
Status: `INVESTIGATE` — see `../operations/ai-product-analytics.md`

Product analytics evidence flow in development:

``` text
Product Question Registry (../operations/analytics-questions.md)
→ typed events (../operations/analytics.md)
→ PostHog evidence layer (../decisions/0002-analytics-service.md)
→ deterministic query
→ structured evidence
