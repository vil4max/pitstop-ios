...
**Owners:** Product decisions stay in [`../requirements/product-charter.md`](../requirements/product-charter.md) and [`../decisions/0004-product-design-rationale.md`](../decisions/0004-product-design-rationale.md). This document owns the review ritual and checklist.
...
Charter JTBD owners live in [`../requirements/product-charter.md`](../requirements/product-charter.md). Every feature must strengthen at least one of them:
...
Pit remains a helper for capture, clarification, and progressive discovery — not a generic chatbot. See Pit boundary in [`../requirements/product-charter.md`](../requirements/product-charter.md).
...
Align with product-core failure criteria in [`../requirements/product-charter.md`](../requirements/product-charter.md).
...
Slice-specific non-goals remain owned by [`../requirements/product-charter.md`](../requirements/product-charter.md). When Product Review rejects a category permanently, add it here and mirror a short note in the charter if it changes product identity.
...
Rejected or deferred ideas with lasting product meaning should leave a short note in [`../decisions/0004-product-design-rationale.md`](../decisions/0004-product-design-rationale.md) so the same idea is not rediscovered as "obviously good."
