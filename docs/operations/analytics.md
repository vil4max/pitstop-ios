...
Provider source of truth: `../decisions/0002-analytics-service.md`

Product question source of truth: `analytics-questions.md`

AI-assisted analytics workflow source of truth: `ai-product-analytics.md`
...
product analytics provider. See `../decisions/0002-analytics-service.md`.
...
Primary questions are defined in `analytics-questions.md` as `AQ-*`
entries.
...
`telemetry-contract.md` and `ai-product-analytics.md`.
...
Authoritative definitions: `analytics-questions.md`.
