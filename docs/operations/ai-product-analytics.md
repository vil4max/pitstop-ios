...
**Depends on:** `../decisions/0002-analytics-service.md`,
...
maintain `analytics-questions.md`; - connect each P0 event to
...
-   `analytics-questions.md` is the question/threshold source of
    truth;
...
-   `AIA-001` is defined;
-   privacy constraints are inherited from `telemetry-contract.md`;
