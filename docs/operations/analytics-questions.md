...
**Depends on:** `analytics.md`, `telemetry-contract.md`\
**Referenced by:** `ai-product-analytics.md`
...
Provider selection is owned by `../decisions/0002-analytics-service.md`.

Event taxonomy is owned by `analytics.md`.
...
Event semantics are defined in `analytics.md`.
...
`../engineering/ai-architecture.md` and are separate from this product question.
...
| --- | --- | --- |
| Analytics smoke validation before TestFlight | `release-and-beta.md` release gate | `P0` |
...
mark it `REVIEW` in `analytics.md` and do not collect it.
...
Workflow details: `ai-product-analytics.md`.

Do not start `AIA-001` until all prerequisites are satisfied.

## Related documents

-   `analytics.md` — event taxonomy and P0 event ownership table
-   `../decisions/0002-analytics-service.md` — analytics provider selection
-   `ai-product-analytics.md` — AI-assisted analytics workflow
-   `telemetry-contract.md` — privacy and telemetry channels
