...
enum PitstopMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [PitstopSchemaV1.self, PitstopSchemaV2.self, PitstopSchemaV3.self, PitstopSchemaV4.self, PitstopSchemaV5.self]
    }

    static var stages: [MigrationStage] {
        // Each version only adds an entity or optional attributes, so no earlier row is transformed (ADR 0016,
        // ADR 0032, ADR 0035, ADR 0040). A V1 store passes through every stage in turn.
        [
            ...
            .lightweight(fromVersion: PitstopSchemaV4.self, toVersion: PitstopSchemaV5.self),
        ]
    }
}
