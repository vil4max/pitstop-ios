...
Next task: CB-006; CB-001…005 are implemented; INV-ROAD is decided in ADR 0008; DOM-003 and ENG-004 are implemented on unmerged branches (see [`docs/planning/work-plan.md`](docs/planning/work-plan.md)).
