...
**Next task:** RD-001, the Car Board redesign card (RD-000 landed on `redesign/ios27`, ADR 0038) ([`docs/planning/work-plan.md`](docs/planning/work-plan.md)); the round ends with SYS-008 and TestFlight 1.2.0  
